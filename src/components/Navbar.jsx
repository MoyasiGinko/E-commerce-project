...
const Navbar = () => {
  ...
  const isDesktop = typeof window !== "undefined" && window.innerWidth > 768; // Set initial screen size
  ...
  if (!role) {
    // Render a default navbar with a "Home" link
    return (
      <>
        <button
        ...
        {/* Default Navbar */}
        <nav className="fixed top-0 left-0 z-50 w-full bg-gray-800 p-3">
          <div className="text-white">MicroCommerce</div>
          <ul className="space-y-4 mt-4">
            <li>
              <button
                type="button"
                className="text-lg font-semibold text-gray-300 hover:bg-gray-700 hover:text-red-600 px-4 py-2 rounded-full"
